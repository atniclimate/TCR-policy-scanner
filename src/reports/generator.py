...
policy items, formatted for Tribal Leaders.
"""
...
class ReportGenerator:
    ...
    def generate(self, scored_items: list[dict], changes: dict) -> dict:
        """Generate both Markdown and JSON reports. Returns file paths."""
        timestamp = datetime.utcnow().strftime("%Y-%m-%d")
        md_content = self._build_markdown(scored_items, changes, timestamp)
        json_content = self._build_json(scored_items, changes, timestamp)
    ...
    def _build_markdown(self, items: list[dict], changes: dict, timestamp: str) -> str:
    ...
    def _build_json(self, items: list[dict], changes: dict, timestamp: str) -> dict:

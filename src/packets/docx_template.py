...
class TemplateBuilder:
    ...
    def _setup_header_footer(document: Document) -> None:
        """Configure header and footer with branding and page numbers."""
        for section in document.sections:
            # --- Header ---
            ...
            # "CONFIDENTIAL | Generated by TCR Policy Scanner | Page X"
            conf_run = footer_para.add_run(
                "CONFIDENTIAL | Generated by TCR Policy Scanner | Page "
            )

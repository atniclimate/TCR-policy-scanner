...
logger = logging.getLogger("tcr_scanner.packets.strategic_overview")
...
class StrategicOverviewGenerator:
    ...
    def __init__(self, config: dict, programs: dict[str, dict]) -> None:
        ...
        self.monitor_data = self._load_json("outputs/LATEST-MONITOR-DATA.json")
    ...
    def _setup_header_footer(self, document: Document) -> None:
        ...
        Header: "FY26 Federal Funding Overview" (Arial 8pt, muted)
    ...
    def _render_cover(self, document: Document, style_manager: StyleManager) -> None:
        ...
        # Main title
        document.add_heading("FY26 Federal Funding Overview & Strategy", level=1)

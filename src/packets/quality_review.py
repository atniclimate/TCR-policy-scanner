...
class DocumentQualityReviewer:
    ...
    def review_document(
        ...
        # Check 7: MAX_PAGES enforcement (Hot Sheets only)
        # Estimate page count via page breaks + section breaks
        page_breaks = sum(
            1
        ...
        # Each document starts on page 1, so total pages = breaks + 1

# Requirements Archive: v1.1 Tribe-Specific Advocacy Packets
...
- [x] **CONG-01**: Tribe-to-congressional-district mapping modeled as many-to-many (Census CD119-AIANNH), correctly handling multi-state Tribes (e.g., Navajo = 4 districts, 3 states) and Alaska at-large
...
**Adjusted:**
- CONG-01 data source changed from CRS R48107 (118th Congress PDF) to Census CD119-AIANNH (119th Congress machine-readable)
- AF-04 superseded by ProgramRelevanceFilter (8-12 programs per Tribe instead of all 16)
- AF-05 superseded by lightweight GitHub Pages widget (WEB-01/02/03)
**Dropped:** None

...
@.planning/phases/19-schema-core-data/19-CONTEXT.md -- User decisions: 5-tier scale, data gap messages, SVI Theme 3 exclusion, composite formula
@.planning/phases/19-schema-core-data/19-RESEARCH.md -- Pydantic v2 patterns, code examples, anti-patterns
</context>
...
<feature>
  ...
  <behavior>
    ...
    **DataGapType** (str enum):
    ...
    - Each maps to a reader-facing message string (from 19-CONTEXT.md decisions)
  ...
  <implementation>
    ...
    - GAP_MESSAGES dict mapping DataGapType -> reader-facing message string (from 19-CONTEXT.md)
...
<output>
After completion, create `.planning/phases/19-schema-core-data/19-02-SUMMARY.md`
</output>
